...
public class User implements Serializable {
	...
	public User( String loginname, String password, String username, Integer status, Date createdate, String token) {
	...
	public User(String lgname) {
		this.loginname = lgname;
	}
